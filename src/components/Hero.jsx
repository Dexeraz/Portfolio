...
const Hero = () => {
  return (
    <section className="relative w-full h-scree mx-auto" >
      <div
        className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-71 mx-auto flex flex-row items-start gap-5`}
      >
